...
namespace AForge.Imaging.Formats
{
    ...
    /// // decode image file
    /// AForge.Bitmap = ImageDecoder.DecodeFromFile( fileName );
    /// </code>
    /// </remarks>
    /// 
    ...
    public class ImageDecoder
    {
        ...
        public static AForge.Bitmap DecodeFromFile( string fileName, out ImageInfo imageInfo )
        {
            ...
            if ( ( fileExtension != string.Empty ) && ( fileExtension.Length != 0 ) )
            {
                ...
                if ( decoders.ContainsKey( fileExtension ) )
                {
                    ...
                    map = decoder.DecodeFrame( 0, out imageInfo );
        ...
        private static AForge.Bitmap FromFile( string fileName )
        {
