...
namespace AForge.Imaging
{
    ...
    public class ImageStatisticsHSL
    {
        ...
        /// 
        public ImageStatisticsHSL( AForge.Bitmap image )
        {
        ...
        /// 
        public ImageStatisticsHSL( AForge.Bitmap image, AForge.Bitmap mask )
        {
            CheckSourceFormat( image.PixelFormat );
        ...
        /// <exception cref="ArgumentException">Mask must have the same size as the source image to get statistics for.</exception>
        /// 
        public ImageStatisticsHSL( AForge.Bitmap image, byte[,] mask )
        {
            CheckSourceFormat( image.PixelFormat );
