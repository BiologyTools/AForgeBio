...
namespace AForge.Imaging
{
    ...
    /// IntegralImage im = IntegralImage.FromAForge.Bitmap( image );
    ...
    public class IntegralImage
    {
        ...
        /// 
        public static IntegralImage FromBitmap( AForge.Bitmap image )
        {
            // check image format
        ...
        /// <exception cref="UnsupportedImageFormatException">The source image has incorrect pixel format.</exception>
        /// 
        public static IntegralImage FromBitmap( AForge.BitmapData imageData )
        {
