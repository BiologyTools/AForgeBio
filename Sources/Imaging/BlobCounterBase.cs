...
namespace AForge.Imaging
{
    ...
    public abstract class BlobCounterBase
    {
        ...
        /// </summary>
        /// 
        /// <remarks><para>Number of objects (blobs) found by <see cref="ProcessImage(AForge.Bitmap)"/> method.
        /// </para></remarks>
        /// 
        ...
        /// or extract them, the <see cref="ProcessImage(AForge.Bitmap)"/>,
        /// <see cref="ProcessImage(AForge.BitmapData)"/> or <see cref="ProcessImage(UnmanagedImage)"/>
        ...
        /// 
        /// <remarks>Creates new instance of the <see cref="BlobCounterBase"/> class with
        /// initialized objects map built by calling <see cref="ProcessImage(AForge.Bitmap)"/> method.</remarks>
        /// 
        public BlobCounterBase(AForge.Bitmap image )
        {
            ProcessImage( image );
        }
        ...
        /// 
        /// <remarks>Creates new instance of the <see cref="BlobCounterBase"/> class with
        /// initialized objects map built by calling <see cref="ProcessImage(AForge.BitmapData)"/> method.</remarks>
        /// 
        public BlobCounterBase( AForge.BitmapData imageData )
        {
        ...
        /// 
        public void ProcessImage( AForge.Bitmap image )
        {
            // lock source AForge.Bitmap data
            AForge.BitmapData imageData = image.LockBits(
                new Rectangle( 0, 0, image.Width, image.Height ),
                AForge.ImageLockMode.ReadOnly, image.PixelFormat );
        ...
        /// method, the <see cref="ProcessImage(AForge.Bitmap)"/>, <see cref="ProcessImage(AForge.BitmapData)"/>
        ...
        /// Blob's image may be extracted later using <see cref="ExtractBlobsImage( AForge.Bitmap, Blob, bool )"/>
        ...
        /// can not be collected.</exception>
        /// 
        public Blob[] GetObjects( AForge.Bitmap image, bool extractInOriginalSize )
        {
            Blob[] blobs = null;
            // lock source AForge.Bitmap data
            AForge.BitmapData imageData = image.LockBits(
        ...
        public Blob[] GetObjects( UnmanagedImage image, bool extractInOriginalSize )
        {
            ...
            int pixelSize = AForge.Bitmap.GetPixelFormatSize( image.PixelFormat ) / 8;
        ...
        /// 
        public void ExtractBlobsImage( AForge.Bitmap image, Blob blob, bool extractInOriginalSize )
        {
            // lock source AForge.Bitmap data
            AForge.BitmapData imageData = image.LockBits(
                new Rectangle( 0, 0, image.Width, image.Height ),
        ...
        /// 
        /// <remarks><note>By the time this method is called AForge.Bitmap's pixel format is not
