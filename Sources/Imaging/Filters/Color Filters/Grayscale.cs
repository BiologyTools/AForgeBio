...
namespace AForge.Imaging.Filters
{
    ...
    /// // apply the filter
    /// AForge.Bitmap grayImage = filter.Apply( image );
    /// </code>
    /// 
    ...
    public class Grayscale : BaseFilter
    {
        ...
        public static class CommonAlgorithms
        {
            ...
            /// <code>
            /// // apply the filter
            /// AForge.Bitmap grayImage = Grayscale.CommonAlgorithms.BT709.Apply( image );
            /// </code>
            /// </remarks>
            /// 
            ...
            /// <code>
            /// // apply the filter
            /// AForge.Bitmap grayImage = Grayscale.CommonAlgorithms.RMY.Apply( image );
            /// </code>
            /// </remarks>
            /// 
            ...
            /// <code>
            /// // apply the filter
            /// AForge.Bitmap grayImage = Grayscale.CommonAlgorithms.Y.Apply( image );
            /// </code>
            /// </remarks>
            /// 
