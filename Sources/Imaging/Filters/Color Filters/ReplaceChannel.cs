...
namespace AForge.Imaging.Filters
{
    ...
    /// AForge.Bitmap channel = extractFilter.Apply( image );
    /// // threshold channel
    ...
    public class ReplaceChannel : BaseInPlacePartialFilter
    {
        ...
        /// 
        public ReplaceChannel( short channel, AForge.Bitmap channelImage ) : this( )
        {
            this.Channel = channel;
        ...
        protected override unsafe void ProcessFilter( UnmanagedImage image, Rectangle rect )
        {
            ...
            if ( channelImage != null )
            {
                ...
                chData = channelImage.LockBits(
                    ...
                    AForge.ImageLockMode.ReadOnly, channelImage.PixelFormat );
