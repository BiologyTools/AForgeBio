...
namespace AForge.Imaging.Filters
{
    ...
    /// // apply the filter
    /// AForge.Bitmap resultImage = filter.Apply( sourceImage );
    /// </code>
    ///
    ...
    public class MoveTowards : BaseInPlaceFilter2
    {
        ...
        /// 
        public MoveTowards( AForge.Bitmap overlayImage )
            : base( overlayImage )
        {
            InitFormatTranslations( );
        }
        ...
        /// 
        public MoveTowards( AForge.Bitmap overlayImage, int stepSize )
            : base( overlayImage )
        {
            InitFormatTranslations( );
            StepSize = stepSize;
