...
namespace AForge.Imaging.Filters
{
    ...
    {
        private AForge.Bitmap sourceImage = null;
        ...
        /// </remarks>
        ///
        public AForge.Bitmap SourceImage
        {
        ...
        /// 
        public BackwardQuadrilateralTransformation( AForge.Bitmap sourceImage )
            : this( )
        {
        ...
        /// 
        public BackwardQuadrilateralTransformation( AForge.Bitmap sourceImage, List<IntPoint> destinationQuadrilateral )
            : this( )
        {
            this.sourceImage = sourceImage;
        ...
        protected override unsafe void ProcessFilter( UnmanagedImage image )
        {
            ...
            if ( sourceImage != null )
            {
                ...
                // lock source image
                AForge.BitmapData srcData = sourceImage.LockBits(
