...
namespace AForge.Imaging.Filters
{
    ...
    ///                                     YCbCr.CbIndex );
    /// // extract Cb channel
    /// AForge.Bitmap cbChannel = extractFilter.Apply( image );
    /// // invert the channel
    ...
    public class YCbCrReplaceChannel : BaseInPlacePartialFilter
    {
        ...
        private AForge.Bitmap channelImage;
        ...
        /// 
        public AForge.Bitmap ChannelImage
        {
        ...
        /// 
        public YCbCrReplaceChannel( short channel, AForge.Bitmap channelImage ) : this( )
        {
            this.Channel = channel;
