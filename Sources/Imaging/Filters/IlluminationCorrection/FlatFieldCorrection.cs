...
namespace AForge.Imaging.Filters
{
    ...
    {
        AForge.Bitmap backgroundImage = null;
        ...
        /// </remarks>
        /// 
        public AForge.Bitmap BackgoundImage
        {
        ...
        /// 
        public FlatFieldCorrection( AForge.Bitmap backgroundImage ) : this( )
        {
        ...
        protected override unsafe void ProcessFilter( UnmanagedImage image )
        {
            ...
            AForge.BitmapData bgLockedData = null;
            ...
            else
            {
                if ( backgroundImage != null )
                {
                    ...
                    bgLockedData = backgroundImage.LockBits(
                        ...
                        AForge.ImageLockMode.ReadOnly, backgroundImage.PixelFormat );
