...
namespace AForge.Imaging.Filters
{
    ...
    /// 
    /// <para>Mask can be specified as <see cref="MaskImage">.NET's managed AForge.Bitmap</see>, as
    ...
    public class MaskedFilter : BaseInPlacePartialFilter
    {
        ...
        private AForge.Bitmap maskImage;
        ...
        /// 
        public AForge.Bitmap MaskImage
        {
        ...
        /// 
        public MaskedFilter( IFilter baseFiler, AForge.Bitmap maskImage )
        {
        ...
        protected override unsafe void ProcessFilter( UnmanagedImage image, Rectangle rect )
        {
            ...
            else if ( maskImage != null )
            {
                ...
                AForge.BitmapData maskData = maskImage.LockBits( new Rectangle( 0, 0, image.Width, image.Height ),
