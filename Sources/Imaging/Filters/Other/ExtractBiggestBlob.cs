...
namespace AForge.Imaging.Filters
{
    ...
    /// <see cref="Apply( AForge.Bitmap )"/> method and also for the <see cref="OriginalImage"/>.</para>
    /// 
    ...
    /// // apply the filter
    /// AForge.Bitmap biggestBlobsImage = filter.Apply( image );
    /// </code>
    /// 
    ...
    {
        private AForge.Bitmap originalImage = null;
        ...
        /// is extracted from the image, which is passed to <see cref="Apply(AForge.Bitmap)"/> image.</para>
        /// </remarks>
        /// 
        public AForge.Bitmap OriginalImage
        {
        ...
        public AForge.Bitmap Apply( AForge.BitmapData imageData )
        {
            ...
            AForge.Bitmap managedImage = biggestBlob.Image.ToManagedImage( );
