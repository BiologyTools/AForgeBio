...
namespace AForge.Imaging.Filters
{
    ...
    public abstract class BaseUsingCopyPartialFilter : IFilter, IInPlaceFilter, IInPlacePartialFilter, IFilterInformation
    {
        ...
        ///
        public AForge.Bitmap Apply( AForge.Bitmap image )
        {
            // lock source AForge.Bitmap data
            AForge.BitmapData srcData = image.LockBits(
		...
		/// the source image.</returns>
		/// 
		/// <remarks>The filter accepts AForge.Bitmap data as input and returns the result
		/// of image processing filter as new image. The source image data are kept
		/// unchanged.</remarks>
		///
        /// <exception cref="UnsupportedImageFormatException">Unsupported pixel format of the source image.</exception>
        ///
        public AForge.Bitmap Apply( AForge.BitmapData imageData )
        {
            ...
            AForge.Bitmap dstImage = ( dstPixelFormat == PixelFormat.Format8bppIndexed ) ?
                AForge.Imaging.Image.CreateGrayscaleImage( width, height ) :
                new AForge.Bitmap( width, height, dstPixelFormat );

            // lock destination AForge.Bitmap data
            AForge.BitmapData dstData = dstImage.LockBits(
                new Rectangle( 0, 0, width, height ),
                AForge.ImageLockMode.ReadWrite, dstPixelFormat );
        ...
        /// <exception cref="UnsupportedImageFormatException">Unsupported pixel format of the source image.</exception>
        /// 
        public void ApplyInPlace( AForge.Bitmap image )
        {
            // apply the filter
        ...
        /// <exception cref="UnsupportedImageFormatException">Unsupported pixel format of the source image.</exception>
        ///
        public void ApplyInPlace( AForge.BitmapData imageData )
        {
            // apply the filter
        ...
        /// <exception cref="UnsupportedImageFormatException">Unsupported pixel format of the source image.</exception>
        /// 
        public void ApplyInPlace( AForge.Bitmap image, Rectangle rect )
        {
            // lock source AForge.Bitmap data
            AForge.BitmapData data = image.LockBits(
                new Rectangle( 0, 0, image.Width, image.Height ),
                AForge.ImageLockMode.ReadWrite, image.PixelFormat );
            try
            {
                // apply the filter
        ...
        /// <exception cref="UnsupportedImageFormatException">Unsupported pixel format of the source image.</exception>
        ///
        public void ApplyInPlace( AForge.BitmapData imageData, Rectangle rect )
        {
            // apply the filter
