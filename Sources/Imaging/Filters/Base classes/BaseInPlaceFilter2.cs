...
namespace AForge.Imaging.Filters
{
    ...
    {
        private AForge.Bitmap overlayImage;
        ...
        /// </remarks>
        ///
        public AForge.Bitmap OverlayImage
        {
        ...
        /// 
        protected BaseInPlaceFilter2( AForge.Bitmap overlayImage )
        {
        ...
        protected override unsafe void ProcessFilter( UnmanagedImage image )
        {
            ...
            if ( overlayImage != null )
            {
                ...
                // lock overlay image
                AForge.BitmapData ovrData = overlayImage.LockBits(
                    new Rectangle( 0, 0, width, height ),
                        AForge.ImageLockMode.ReadOnly, pixelFormat );
