...
namespace AForge.Imaging
{
    ...
    /// ComplexImage complexImage = ComplexImage.FromAForge.Bitmap( image );
    /// // do forward Fourier transformation
    /// complexImage.ForwardFourierTransform( );
    /// // get complex image as bitmat
    /// AForge.Bitmap fourierImage = complexImage.ToAForge.Bitmap( );
    /// </code>
    /// 
    ...
    public class ComplexImage : ICloneable
    {
        ...
        /// class directly. To create an instance of this class <see cref="FromAForge.Bitmap(AForge.Bitmap)"/> or
        /// <see cref="FromAForge.Bitmap(AForge.BitmapData)"/> method should be used.</remarks>
        ///
        ...
        /// <summary>
        /// Create complex image from grayscale AForge.Bitmap.
        /// </summary>
        /// 
        /// <param name="image">Source grayscale AForge.Bitmap (8 bpp indexed).</param>
        /// 
        ...
        /// 
        public static ComplexImage FromBitmap( AForge.Bitmap image )
        {
            // check image format
            ...
            AForge.BitmapData imageData = image.LockBits(
                ...
                AForge.ImageLockMode.ReadOnly, PixelFormat.Format8bppIndexed );
        ...
        /// <exception cref="InvalidImagePropertiesException">Image width and height should be power of 2.</exception>
        /// 
        public static ComplexImage FromBitmap( AForge.BitmapData imageData )
        {
            // check image format
        ...
        /// <summary>
        /// Convert complex image to AForge.Bitmap.
        /// </summary>
        /// 
        /// <returns>Returns grayscale AForge.Bitmap.</returns>
        /// 
        public AForge.Bitmap ToBitmap( )
        {
            // create new image
            AForge.Bitmap dstImage = AForge.Imaging.Image.CreateGrayscaleImage( width, height );

            // lock destination AForge.Bitmap data
            AForge.BitmapData dstData = dstImage.LockBits(
                new Rectangle( 0, 0, width, height ),
                AForge.ImageLockMode.ReadWrite, PixelFormat.Format8bppIndexed );
