...
namespace AForge.Imaging
{
    ...
    public static class Drawing
    {
        ...
        /// 
        public static unsafe void FillRectangle( AForge.BitmapData imageData, Rectangle rectangle, Color color )
        {
        ...
        /// <exception cref="UnsupportedImageFormatException">The source image has incorrect pixel format.</exception>
        /// 
        public static unsafe void Rectangle( AForge.BitmapData imageData, Rectangle rectangle, Color color )
        {
        ...
        /// <exception cref="UnsupportedImageFormatException">The source image has incorrect pixel format.</exception>
        /// 
        public static unsafe void Line( AForge.BitmapData imageData, IntPoint point1, IntPoint point2, Color color )
        {
        ...
        /// </para></remarks>
        /// 
        public static void Polygon( AForge.BitmapData imageData, List<IntPoint> points, Color color )
        {
        ...
        /// first one to the last one. Unlike <see cref="Polygon( AForge.BitmapData, List{IntPoint}, Color )"/>
        /// method, this method does not connect the last point with the first one.
        /// </para></remarks>
        /// 
        public static void Polyline( AForge.BitmapData imageData, List<IntPoint> points, Color color )
        {
