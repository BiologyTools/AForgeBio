...
namespace AForge.Imaging
{
    ...
    public class Blob
    {
        ...
        /// the image may be extracted using <see cref="BlobCounterBase.ExtractBlobsImage( AForge.Bitmap, Blob, bool )"/>
        ...
        /// image may be extracted later using <see cref="BlobCounterBase.ExtractBlobsImage( AForge.Bitmap, Blob, bool )"/>
        /// or <see cref="BlobCounterBase.ExtractBlobsImage( UnmanagedImage, Blob, bool )"/> method.</para></remarks>
        /// 
