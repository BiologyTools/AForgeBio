...
namespace AForge.Imaging
{
    ...
    /// AForge.Bitmap managedImage = unmanagedImage.ToManagedImage( );
    /// </code>
    /// </remarks>
    /// 
    public class UnmanagedImage : IDisposable
    {
        ...
        /// 
        /// <remarks><note>Unlike <see cref="FromManagedImage(AForge.BitmapData)"/> method, this constructor does not make
        ...
        /// 
        public AForge.Bitmap ToManagedImage( )
        {
        ...
        /// 
        public AForge.Bitmap ToManagedImage( bool makeCopy )
        {
            AForge.Bitmap dstImage = null;

            try
            {
                if ( !makeCopy )
                {
                    dstImage = new AForge.Bitmap( width, height, stride, pixelFormat, imageData );
                ...
                else
                {
                    ...
                    dstImage = ( pixelFormat == PixelFormat.Format8bppIndexed ) ?
                        ...
                        new AForge.Bitmap( width, height, pixelFormat );

                    // lock destination AForge.Bitmap data
                    AForge.BitmapData dstData = dstImage.LockBits(
                        new Rectangle( 0, 0, width, height ),
                        AForge.ImageLockMode.ReadWrite, pixelFormat );
        ...
        /// 
        public static UnmanagedImage FromManagedImage( AForge.Bitmap image )
        {
            UnmanagedImage dstImage = null;

            AForge.BitmapData sourceData = image.LockBits( new Rectangle( 0, 0, image.Width, image.Height ),
        ...
        /// <exception cref="UnsupportedImageFormatException">Unsupported pixel format of source image.</exception>
        /// 
        public static UnmanagedImage FromManagedImage( AForge.BitmapData imageData )
        {
        ...
        {
            int pixelSize = AForge.Bitmap.GetPixelFormatSize( pixelFormat ) / 8;
        ...
        public static implicit operator UnmanagedImage(AForge.Bitmap v)
        {
            return v.Image;
        }
