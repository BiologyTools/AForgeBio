...
namespace AForge.Imaging
{
    ...
    public interface ITemplateMatching
    {
        ...
        /// 
        TemplateMatch[] ProcessImage( AForge.Bitmap image, AForge.Bitmap template, Rectangle searchZone );
        ...
        /// <returns>Returns array of found matchings.</returns>
        /// 
        TemplateMatch[] ProcessImage( AForge.BitmapData imageData, AForge.BitmapData templateData, Rectangle searchZone );
