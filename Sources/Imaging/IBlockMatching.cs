...
namespace AForge.Imaging
{
    ...
    public interface IBlockMatching
    {
        ...
        /// 
        List<BlockMatch> ProcessImage( AForge.Bitmap sourceImage, List<IntPoint> coordinates, AForge.Bitmap searchImage );
        ...
        /// <returns>Returns list of found block matches.</returns>
        /// 
        List<BlockMatch> ProcessImage( AForge.BitmapData sourceImageData, List<IntPoint> coordinates, AForge.BitmapData searchImageData );
