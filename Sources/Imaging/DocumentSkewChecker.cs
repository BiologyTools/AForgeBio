...
namespace AForge.Imaging
{
    ...
    /// AForge.Bitmap rotatedImage = rotationFilter.Apply( documentImage );
    /// </code>
    /// 
    ...
    public class DocumentSkewChecker
    {
        ...
        /// 
        public double GetSkewAngle( AForge.Bitmap image )
        {
        ...
        /// <exception cref="UnsupportedImageFormatException">Unsupported pixel format of the source image.</exception>
        /// 
        public double GetSkewAngle( AForge.Bitmap image, Rectangle rect )
        {
            // check image format
        ...
        /// <exception cref="UnsupportedImageFormatException">Unsupported pixel format of the source image.</exception>
        /// 
        public double GetSkewAngle( AForge.BitmapData imageData )
        {
        ...
        /// <exception cref="UnsupportedImageFormatException">Unsupported pixel format of the source image.</exception>
        /// 
        public double GetSkewAngle( AForge.BitmapData imageData, Rectangle rect )
        {
