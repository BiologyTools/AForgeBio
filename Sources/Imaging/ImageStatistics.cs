...
namespace AForge.Imaging
{
    ...
    public class ImageStatistics
    {
        ...
        /// 
        public ImageStatistics( AForge.Bitmap image )
        {
        ...
        /// 
        public ImageStatistics( AForge.Bitmap image, AForge.Bitmap mask )
        {
            CheckSourceFormat( image.PixelFormat );
        ...
        /// <exception cref="ArgumentException">Mask must have the same size as the source image to get statistics for.</exception>
        /// 
        public ImageStatistics( AForge.Bitmap image, byte[,] mask )
        {
            CheckSourceFormat( image.PixelFormat );
