...
namespace AForge.Imaging
{
    ...
    public class RecursiveBlobCounter : BlobCounterBase
    {
        ...
        /// or extract them, the <see cref="BlobCounterBase.ProcessImage(AForge.Bitmap)"/>,
        /// <see cref="BlobCounterBase.ProcessImage(AForge.BitmapData)"/> or <see cref="BlobCounterBase.ProcessImage(UnmanagedImage)"/>
        ...
        /// 
        public RecursiveBlobCounter( AForge.Bitmap image ) : base( image ) { }
        ...
        /// 
        public RecursiveBlobCounter( AForge.BitmapData imageData ) : base( imageData ) { }
        ...
        protected override void BuildObjectsMap( UnmanagedImage image )
        {
            ...
            unsafe
            {
                ...
                {
                    pixelSize = AForge.Bitmap.GetPixelFormatSize( image.PixelFormat ) / 8;
