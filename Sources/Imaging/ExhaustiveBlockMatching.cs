...
namespace AForge.Imaging
{
    ...
    public class ExhaustiveBlockMatching : IBlockMatching
    {
        ...
        /// 
        public List<BlockMatch> ProcessImage( AForge.Bitmap sourceImage, List<IntPoint> coordinates, AForge.Bitmap searchImage )
        {
            // lock source image
            AForge.BitmapData sourceImageData = sourceImage.LockBits(
                new Rectangle( 0, 0, sourceImage.Width, sourceImage.Height ),
                AForge.ImageLockMode.ReadOnly, sourceImage.PixelFormat );

            AForge.BitmapData searchImageData = searchImage.LockBits(
                new Rectangle( 0, 0, searchImage.Width, searchImage.Height ),
                AForge.ImageLockMode.ReadOnly, searchImage.PixelFormat );
        ...
        /// 
        public List<BlockMatch> ProcessImage( AForge.BitmapData sourceImageData, List<IntPoint> coordinates, AForge.BitmapData searchImageData )
        {
