...
namespace AForge.Imaging.Textures
{
    ...
    /// AForge.Bitmap textureImage = TextureTools.ToAForge.Bitmap( texture );
    /// </code>
    /// </remarks>
    /// 
    public class TextureTools
    {
        ...
        /// <summary>
        /// Convert texture to grayscale AForge.Bitmap.
        /// </summary>
        /// 
        /// <param name="texture">Texture to convert to AForge.Bitmap.</param>
        /// 
        /// <returns>Returns AForge.Bitmap of the texture.</returns>
        /// 
        public static AForge.Bitmap ToBitmap( float[,] texture )
        {
        ...
        /// <summary>
        /// Convert grayscale AForge.Bitmap to texture.
        /// </summary>
        /// 
        ...
        /// 
        public static float[,] FromBitmap( AForge.Bitmap image )
        {
        ...
        /// <exception cref="UnsupportedImageFormatException">Only grayscale (8 bpp indexed images) are supported.</exception>
        /// 
        public static float[,] FromBitmap( AForge.BitmapData imageData )
        {
