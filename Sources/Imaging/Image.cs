...
namespace AForge.Imaging
{
    ...
    public static class Image
    {
        ...
        /// 
        public static bool IsGrayscale( AForge.Bitmap image )
        {
            bool ret = false;
            ...
            if ( image.PixelFormat == PixelFormat.Format8bppIndexed )
            {
                ret = true;
                // check palette
                AForge.Bitmap.ColorPalette cp = image.Palette;
                Color c;
                // init palette
                for ( int i = 0; i < 256; i++ )
                {
        ...
        /// 
        public static AForge.Bitmap CreateGrayscaleImage( int width, int height )
        {
            // create new image
            AForge.Bitmap image = new AForge.Bitmap( width, height, PixelFormat.Format8bppIndexed );
        ...
        /// 
        public static void SetGrayscalePalette( AForge.Bitmap image )
        {
            // check pixel format
            if ( image.PixelFormat != PixelFormat.Format8bppIndexed )
        ...
        ///
        /// <remarks>The original <see cref="AForge.Bitmap.Clone(Rectangle, Imaging.PixelFormat)">AForge.Bitmap.Clone()</see>
        ...
        ///
        public static AForge.Bitmap Clone( AForge.Bitmap source, PixelFormat format )
        {
            return source.Copy();
        }
        ...
        /// of the image). That is why this method was implemented to provide the functionality.</remarks> 
        /// 
        public static AForge.Bitmap Clone( AForge.Bitmap source )
        {
            // lock source AForge.Bitmap data
            AForge.BitmapData sourceData = source.LockBits(
                new Rectangle( 0, 0, source.Width, source.Height ),
                AForge.ImageLockMode.ReadOnly, source.PixelFormat );

            // create new image
            AForge.Bitmap destination = Clone( sourceData );
            ...
            {
                AForge.Bitmap.ColorPalette srcPalette = source.Palette;
                AForge.Bitmap.ColorPalette dstPalette = destination.Palette;
        ...
        /// 
        public static AForge.Bitmap Clone( AForge.BitmapData sourceData )
        {
            ...
            // create new image
            AForge.Bitmap destination = new AForge.Bitmap( width, height, sourceData.PixelFormat );

            // lock destination AForge.Bitmap data
            AForge.BitmapData destinationData = destination.LockBits(
                new Rectangle( 0, 0, width, height ),
                AForge.ImageLockMode.ReadWrite, destination.PixelFormat );
        ...
        /// <see cref="Imaging.PixelFormat">Format24bppRgb</see> or
        /// <see cref="Imaging.PixelFormat">Format32bppRgb</see> or
        /// <see cref="Imaging.PixelFormat">Format32bppArgb</see> or
        /// <see cref="Imaging.PixelFormat">Format48bppRgb</see> or
        /// <see cref="Imaging.PixelFormat">Format64bppArgb</see>
        /// format or it is <see cref="IsGrayscale">grayscale</see>, otherwise the image
        /// is converted to <see cref="Imaging.PixelFormat">Format24bppRgb</see>
        /// format.</para>
        /// 
        /// <para><note>The method is deprecated and <see cref="Clone(AForge.Bitmap, PixelFormat)"/> method should
        /// be used instead with specifying desired pixel format.</note></para>
        /// </remarks>
        ///
        [Obsolete( "Use Clone(AForge.Bitmap, PixelFormat) method instead and specify desired pixel format" )]
        public static void FormatImage( ref AForge.Bitmap image )
        {
            if (
        ...
        /*
        /// <summary>
        /// Load AForge.Bitmap from file.
        /// </summary>
        /// 
        /// <param name="fileName">File name to load AForge.Bitmap from.</param>
        /// 
        /// <returns>Returns loaded AForge.Bitmap.</returns>
        /// 
        /// <remarks><para>The method is provided as an alternative of <see cref="Image.FromFile(string)"/>
        ...
        /// <code>
        /// AForge.Bitmap image = AForge.Imaging.Image.FromFile( "test.jpg" );
        /// </code>
        /// </remarks>
        /// 
        public static AForge.Bitmap FromFile( string fileName )
        {
            AForge.Bitmap loadedImage = null;
            ...
            try
            {
                ...
                loadedImage = (AForge.Bitmap) AForge.Bitmap.FromStream( memoryStream );
            }
            finally
            {
                if ( stream != null )
        ...
        */
        /// <summary>
        /// Convert AForge.Bitmap with 16 bits per plane to a AForge.Bitmap with 8 bits per plane.
        /// </summary>
        /// 
        ...
        /// 
        public static AForge.Bitmap Convert16bppTo8bpp( AForge.Bitmap bimap )
        {
            AForge.Bitmap newImage = null;
            int layers = 0;
            ...
            switch ( bimap.PixelFormat )
            {
                ...
                case PixelFormat.Format48bppRgb:
                    ...
                    newImage = new AForge.Bitmap( width, height, PixelFormat.Format24bppRgb );
                    layers = 3;
                    break;

                case PixelFormat.Format64bppArgb:
                    // create new color 32 bpp image
                    newImage = new AForge.Bitmap( width, height, PixelFormat.Format32bppArgb );
                    layers = 4;
                    break;

                case PixelFormat.Format64bppPArgb:
                    // create new color 32 bpp image
                    newImage = new AForge.Bitmap( width, height, PixelFormat.Format32bppPArgb );
                    layers = 4;
                    break;
            ...
            // lock both images
            AForge.BitmapData sourceData = bimap.LockBits( new Rectangle( 0, 0, width, height ),
                AForge.ImageLockMode.ReadOnly, bimap.PixelFormat );
            AForge.BitmapData newData = newImage.LockBits( new Rectangle( 0, 0, width, height ),
                AForge.ImageLockMode.ReadWrite, newImage.PixelFormat );
        ...
        /// <summary>
        /// Convert AForge.Bitmap with 8 bits per plane to a AForge.Bitmap with 16 bits per plane.
        /// </summary>
        /// 
        /// <param name="bimap">Source image to convert.</param>
        /// 
        ...
        /// <exception cref="UnsupportedImageFormatException">Invalid pixel format of the source image.</exception>
        /// 
        public static AForge.Bitmap Convert8bppTo16bpp( AForge.Bitmap bimap )
        {
            AForge.Bitmap newImage = null;
            int layers = 0;
            ...
            switch ( bimap.PixelFormat )
            {
                case PixelFormat.Format8bppIndexed:
                    // create new grayscale image
                    newImage = new AForge.Bitmap( width, height, PixelFormat.Format16bppGrayScale );
                    layers = 1;
                    break;

                case PixelFormat.Format24bppRgb:
                    // create new color 48 bpp image
                    newImage = new AForge.Bitmap( width, height, PixelFormat.Format48bppRgb );
                    layers = 3;
                    break;

                case PixelFormat.Format32bppArgb:
                    // create new color 64 bpp image
                    newImage = new AForge.Bitmap( width, height, PixelFormat.Format64bppArgb );
                    layers = 4;
                    break;

                case PixelFormat.Format32bppPArgb:
                    // create new color 64 bpp image
                    newImage = new AForge.Bitmap( width, height, PixelFormat.Format64bppPArgb );
                    layers = 4;
                    break;
