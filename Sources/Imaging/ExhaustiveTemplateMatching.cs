...
namespace AForge.Imaging
{
    ...
    /// AForge.BitmapData data = sourceImage.LockBits(
    ...
    public class ExhaustiveTemplateMatching : ITemplateMatching
    {
        ...
        /// 
        public TemplateMatch[] ProcessImage( AForge.Bitmap image, AForge.Bitmap template )
        {
        ...
        /// <exception cref="InvalidImagePropertiesException">Template image is bigger than source image.</exception>
        /// 
        public TemplateMatch[] ProcessImage( AForge.Bitmap image, AForge.Bitmap template, Rectangle searchZone )
        {
            // check image format
            if (
            ...
            AForge.BitmapData templateData = template.LockBits(
                new Rectangle( 0, 0, template.Width, template.Height ),
                AForge.ImageLockMode.ReadOnly, template.PixelFormat );
        ...
        /// <exception cref="InvalidImagePropertiesException">Template image is bigger than source image.</exception>
        /// 
        public TemplateMatch[] ProcessImage( AForge.BitmapData imageData, AForge.BitmapData templateData )
        {
        ...
        /// <exception cref="InvalidImagePropertiesException">Template image is bigger than source image.</exception>
        /// 
        public TemplateMatch[] ProcessImage( AForge.BitmapData imageData, AForge.BitmapData templateData, Rectangle searchZone )
        {
