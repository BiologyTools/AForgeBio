...
namespace AForge.Imaging
{
    ...
    /// AForge.Bitmap houghLineImage = lineTransform.ToAForge.Bitmap( );
    ...
    public class HoughLineTransformation
    {
        ...
        /// <exception cref="UnsupportedImageFormatException">Unsupported pixel format of the source image.</exception>
        /// 
        public void ProcessImage( AForge.Bitmap image, Rectangle rect )
        {
            // check image format
        ...
        /// <exception cref="UnsupportedImageFormatException">Unsupported pixel format of the source image.</exception>
        /// 
        public void ProcessImage( AForge.BitmapData imageData )
        {
        ...
        /// <exception cref="UnsupportedImageFormatException">Unsupported pixel format of the source image.</exception>
        /// 
        public void ProcessImage( AForge.BitmapData imageData, Rectangle rect )
        {
            ProcessImage( new UnmanagedImage( imageData ), rect );
        }
        ...
        /// <summary>
        /// Convert Hough map to AForge.Bitmap. 
        /// </summary>
        /// 
        /// <returns>Returns 8 bppp grayscale AForge.Bitmap, which shows Hough map.</returns>
        /// 
        ...
        public AForge.Bitmap ToBitmap( )
        {
            ...
            // create new image
            AForge.Bitmap image = AForge.Imaging.Image.CreateGrayscaleImage( width, height );
