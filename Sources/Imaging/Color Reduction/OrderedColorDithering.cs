...
namespace AForge.Imaging.ColorReduction
{
    ...
    /// AForge.Bitmap newImage = dithering.Apply( image );
    /// </code>
    /// 
    ...
    public class OrderedColorDithering
    {
        ...
        /// 
        public AForge.Bitmap Apply( AForge.Bitmap sourceImage )
        {
            AForge.BitmapData data = sourceImage.LockBits( new Rectangle( 0, 0, sourceImage.Width, sourceImage.Height ),
                AForge.ImageLockMode.ReadOnly, sourceImage.PixelFormat );

            AForge.Bitmap result = null;
        ...
        /// <exception cref="UnsupportedImageFormatException">Unsupported pixel format of the source image. It must 24 or 32 bpp color image.</exception>
        /// 
        public unsafe AForge.Bitmap Apply( UnmanagedImage sourceImage )
        {
            ...
            int pixelSize = AForge.Bitmap.GetPixelFormatSize( sourceImage.PixelFormat ) / 8;

            int offset = stride - width * pixelSize;

            // create destination image
            AForge.Bitmap destImage = new AForge.Bitmap( width, height, ( colorTable.Length > 16 ) ?
